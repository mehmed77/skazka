...
class ChildProfile(BaseModel):
    ...
    is_active = models.BooleanField(default=True)
    # Kunlik o'yin limiti (daqiqa) — ota-ona Parent Gate ortida o'rnatadi (Faza 8, §6.3 yumshoq).
    # null = cheksiz (default). Yetganda yumshoq to'xtatish (jazo emas, o'rtada uzmaydi).
    daily_limit_minutes = models.PositiveIntegerField(
        "kunlik limit (daq)", null=True, blank=True
    )
